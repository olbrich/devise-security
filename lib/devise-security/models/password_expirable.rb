    ...
    module PasswordExpirable
      ...
      def need_change_password?
        if expired_password_after_numeric?
          password_changed_at.nil? or password_changed_at < expire_password_after.seconds.ago
        else
          false
        end
      end
      ...
      def update_password_changed
        self.password_changed_at = Time.now if (new_record? or encrypted_password_changed?) and !password_changed_at_changed?
      end
